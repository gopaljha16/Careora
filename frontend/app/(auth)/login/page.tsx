          ...
          <div className="w-full max-w-sm mx-auto space-y-6">
            ...
            <div className="text-center lg:text-left space-y-2">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                Welcome back! Enter your login credentials below to access your applications.
              </p>
            </div>
            ...
            <div className="space-y-5 pt-2">
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <Input 
                              ...
                              className="pl-10 h-11 border-slate-200 dark:border-slate-800 focus-visible:ring-orange-500/50 focus-visible:border-orange-500 rounded-xl bg-slate-50/30 dark:bg-slate-950/20"
                              {...field} 
                            />
                          </div>
                        </FormControl>
                    ...
                    render={({ field }) => (
                      <FormItem className="text-left space-y-1.5">
                        <div className="flex justify-between items-center">
                          ...
                          <a href="#" className="text-[10px] font-bold text-orange-600 hover:text-orange-500 dark:text-orange-400">Forgot password?</a>
                        </div>
                        <FormControl>
                          <div className="relative">
              ...
              <div className="mt-6 text-center text-xs font-semibold text-slate-500 dark:text-slate-400">
                ...
                <Link
                  href="/register"
                  className="font-bold text-orange-600 hover:text-orange-550 dark:text-orange-400"
                >
                  Sign up
                </Link>
              </div>
